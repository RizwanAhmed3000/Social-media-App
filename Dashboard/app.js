...
function postHandler() {
    ...
    div.innerHTML = `<div class="authorsDetails d-flex align-items-center">
    <div class="post-header-container d-flex align-items-center">
        ...
        <div class="userName-id ms-2">
            <p class="mb-1 userTag" style="color: #868686; font-size: 12px;">@${activeUser.firstName}</p>
            <div class="d-flex align-items-center justify-content-center">
                <h5 class="mb-1 username">${activeUser.firstName}</h5>
                <p class="mb-0 ms-2" style="color: #ffc107; font-size: 12px;">1 hour</p>
            </div>
        </div>
    </div>
</div>
...
<div class="postImage-video">
    <img src="https://images.unsplash.com/photo-1635016288720-c52507b9a717?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=435&q=80" alt="" class="img-fluid" style="object-fit: cover; width: 100%; border-radius: 15px;">
</div>
